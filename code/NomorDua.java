...
// Method untuk mencari mahasiswa berdasarkan NIM
    public static Mahasiswa2 cariMahasiswaByNim(Mahasiswa2[] daftar, String nimCari) {
...
// Method untuk menampilkan semua data mahasiswa
    public static void tampilkanSemuaData(Mahasiswa2[] daftar) {
        for (Mahasiswa2 m : daftar) {
            m.tampilkanInfo();
            System.out.println(); 
        }
...
// Membuat array daftarMahasiswa 
        Mahasiswa2[] daftarMahasiswa = {
            // Mengisi array dengan 5 objek Mahasiswa
            new Mahasiswa2("Andi", "123456", "Teknik Informatika", 3.5),
            new Mahasiswa2("Budi", "123457", "Teknik Informatika", 3.9),
            new Mahasiswa2("Citra", "123458", "Teknik Informatika", 3.7),
            new Mahasiswa2("Dewi", "123459", "Teknik Informatika", 3.8),
            new Mahasiswa2("Eka", "123460", "Teknik Informatika", 3.6)
        };
...
//Cari mahasiswa berdasarkan NIM
        Mahasiswa2 mhsDitemukan = cariMahasiswaByNim(daftarMahasiswa, nimInput);
